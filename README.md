...
Concerning Spirit Points you can set Sanity "on" in the optional rules settings and use the rules from "The Exorcist Codex" for Spirit Points with the SAN pool (fortunately brp system setting does let you change the 'Sanity' name now, so you can have your custom "Spirit Points" name on the Cs).
