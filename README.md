...
3- Import FIRST, KEEPING THE BRPID, (with right-click) all the content of the "TEC skills" , 
4- Import SECOND,all the "TEC Professions" the same way (keeping brpid) , then 
5- Import LAST, in the same manner "TEC Motivations" (personalities).

If you don't follow these steps, there will be an error when you drag skills or profession onto your character sheets.
